            ...
            <div class="tabs">
                ...
                <div id="tabs-1" class="panel">
                    ...
                    <div style="top: 113px;position: absolute;left: 7px;text-overflow:ellipsis">
                        <span for="genereURL" style="font-size:11px"><?php echo t('URL', FALSE); ?> : </span><span id="totalurl">http://<?php echo $_SERVER['HTTP_HOST'] . BASE_PATH ?><span class="modulename"><?php $modulename = $module->getName();
