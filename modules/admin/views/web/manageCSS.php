...
<style>
    ...
    #opencssfilepath2{color:#fff;font-size:9px;display:none}
...
<form method="POST" id="form_css" action="<?php echo BASE_PATH; ?>admin/saveCSS" target="ajaxhack">
    <div style="min-width:230px;position:relative">
        ...
        <div id="opencssfilepath2">
            <select id="changecsspath" style="width: 229px;" name="filePath">           
                <option><?php echo $filePath; ?></option><option><?php echo $filePath2; ?></option>
            </select>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#changecssformcode').live('click',function(){
            $("#savecssflag").val(0);
        ...
        $('#css_menu > div').live('click',function(){
            $(".panelcss_tab").hide();
        ...
        $('#savemycss').live('click',function(){
            $(this).closest('form').trigger('submit');
        });

        $('#changecsscodetextarea').live('keyup',function(){
        ...
        $("select.autocomplete").each(function(){
            ...
            $('#' + $(this).attr('id')).autocomplete({
                source: x,
                select: function(event, ui) {$(this).autocomplete( "close" );ParsimonyAdmin.displayCSSConf($('#changecsspath').val(),$(this).val());},
    ...
    $('.representation input:not(".resultcss"),.representation select:not(".resultcss")').live('change',function(){
    ...
    $('.resultcss').live('change',function(event){
        obj = $(this).closest('.representation');
        reprToInput2(obj);
    });
    ...
    $('.decoration input').live("change",function(){
        var deco='';
    ...
    $('#changecsspath').live("change",function(){
        ParsimonyAdmin.displayCSSConf($('#changecsspath').val(),$('#current_selector_update').val());
    });
    

    $('#goeditcss').live("click",function(){
        ParsimonyAdmin.displayCSSConf($('#changecsspath').val(),$('#current_selector_update').val());
    });

    $('#current_selector_update').live("keypress",function(e){
    ...
    $("#current_selector_update").live('keyup keydown blur', function(event) {
