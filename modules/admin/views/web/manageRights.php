...
<style>    
    ...
    .modulename{font-size: 18px;color: #777;letter-spacing: 2px;}
    #enablemodule{width: 300px; position: relative;top: -22px;left: 300px;font-size: 18px;color: #777;letter-spacing: 2px;}
    .firsttd{font-size: 18px;letter-spacing: 2px;vertical-align: middle}
    .secondtd{text-transform: capitalize;font-size: 15px;text-align:left}
    </style>
    ...
    <div class="adminzonecontent">
        <form action="" method="POST" target="ajaxhack">
            ...
            <?php
            foreach ($role->select() as $key => $line) {
                echo '<div id="tabs-' . $line->name . '" class="admintabs">';
                ?>
                <div>
                ...
                foreach (\app::$activeModules as $moduleName => $type) {
                    ...
                    <table>
                        <thead>
                            <tr><th></th><th><?php echo t('Label', FALSE); ?></th><th><?php echo t('Display', FALSE); ?></th><th><?php echo t('Insert', FALSE); ?></th><th><?php echo t('Update', FALSE); ?></th><th><?php echo t('Delete', FALSE); ?></th></tr>
                        </thead>
                        <tbody>
                            <?php
