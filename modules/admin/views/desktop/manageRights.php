                        ...
                        <table style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Developer<span class="tooltip ui-icon ui-icon-info floatright" data-tooltip="<?php echo t('All web development rights : Design, Module, blocks, database & so on') ;?>"></span></th></tr>
                            </thead>
                            <tbody>
                                <tr>  
                            ...
                            <tbody>
                                 ...
                                 foreach ($pages as $id_page => $page) {
                                   ...
                                   <tr class="line">
                                    ...
                                    <td><input type="hidden" name="pagesrights[' . $line->id_role . '][' . $moduleName . '][' . $page->getId() . '][display]" value="0"><input type="checkbox" name="pagesrights[' . $line->id_role . '][' . $moduleName . '][' . $page->getId() . '][display]" class="display" ' . $displayChecked . '></td></tr>';
                                }
                                ?></tbody>
                        </table> <?php
                                } 
