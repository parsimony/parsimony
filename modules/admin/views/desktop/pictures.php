...
#crop{background-image: url('<?php echo BASE_PATH?>admin/img/crop.png');width: 48px;height: 48px;display: inline-block;background-position: center 2px;}
#fliph{background-image: url('<?php echo BASE_PATH?>admin/img/fliph.png');width: 48px;height: 48px;display: inline-block;background-position: center;background-repeat: no-repeat;}
#flipv{background-image: url('<?php echo BASE_PATH?>admin/img/flipv.png');width: 48px;height: 48px;display: inline-block;background-position: center;background-repeat: no-repeat;}
#rotateright{background-image: url('<?php echo BASE_PATH?>admin/img/rotateright.png');width: 48px;height: 48px;display: inline-block;background-position:center 2px;}
#rotateleft{background-image: url('<?php echo BASE_PATH?>admin/img/rotateleft.png');width: 48px;height: 48px;display: inline-block;background-position: center 2px;}
#undo{background-image: url('<?php echo BASE_PATH?>admin/img/undo.png');width: 48px;height: 48px;display: inline-block;background-position: center 13px;background-repeat: no-repeat;}
#redo{background-image: url('<?php echo BASE_PATH?>admin/img/redo.png');width: 48px;height: 48px;display: inline-block;background-position: center 13px;background-repeat: no-repeat;}
#resize{background-image: url('<?php echo BASE_PATH?>admin/img/resize.png');width: 48px;height: 48px;display: inline-block;background-position: center;background-repeat: no-repeat;}
#coord{width:110px}
#coord label{display: inline-block;width: 20px}
#coord input{width:45px;margin: 4px 0;}
#preserve{background-image: url('<?php echo BASE_PATH?>admin/img/padlockopen.png');width: 16px;height: 16px;margin-left: 75px;margin-top: -15px;}
#preserve.active{background-image: url('<?php echo BASE_PATH?>admin/img/padlockclosed.png')}
#savepict {position: relative;height: 61px;background: #F8F8F8;padding: 5px;z-index: 999;width: 100%;border-bottom: 1px dashed rgb(221, 221, 221);border-top: 1px solid rgb(221, 221, 221);}
