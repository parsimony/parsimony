...
<div class="flexToolbar">
	...
	<ul class="menu">
		...
		<li style="border-left:0;margin-left: 20px;height:35px;">
	...
	<div style="-webkit-box-flex: 1;-moz-box-flex: 1;box-flex: 1;text-align: right;">
		<div class="rightpart" style="display: inline-block">
			...
			<?php endif; ?>
			<a href="#modules/language" class="floatleft tooltip" data-tooltip="<?php echo t('Current Language', FALSE); ?>" data-pos="s">
				<span class="ui-icon-white ui-icon-flag floatleft"></span><?php echo \request::$locales[\app::$request->getLocale()] ?>
			</a>
			<a href="#modules/profile" class="floatleft tooltip" data-tooltip="<?php echo t('My Profile',false); ?>" data-pos="s">
