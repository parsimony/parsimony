...
<html> 
    <head> 
        ...
        <style>    
            ...
            #content{margin: 200px auto 50px auto;position: relative;width: 503px;height: 253px;box-shadow: 2px 2px 3px #CECECE, 0px 0px 4px #CACACA;}
			...
			#firefox{display:none;font-size: 13px;text-align: center;color: #777;text-shadow: 0px 1px 0px white;}
			#ie{display:none;padding: 100px 0;font-size: 24px;text-align: center;color: #777;text-shadow: 0px 1px 0px white;}
			#firefox a,#ie a{font-weight:bold;text-decoration:none;color: #777;}
        ...
        <script>
            $(document).ready(function () {
                if(navigator.userAgent.toLowerCase().indexOf('firefox') > -1){
					$("#firefox").show();
				} else if(!window.chrome) { /* chrome and opera */
                    $("#content").hide();       
                    $("#ie").show();
                }
