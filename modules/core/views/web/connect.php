...
<html> 
    ...
    <body> 
        <div id="header" style="padding-top: 5px;">
            ...
            <div style="text-shadow: 0px 1px 0px white;font-size: 20px;letter-spacing: 1.5px;color: #555;display: inline-block;bottom: 8px;position: relative;">"<?php echo t('The ability to write code is pretty much a super power in today\'s society',false); ?>" <a style="letter-spacing: 1.5px;" href="http://twitter.com/#!/mattcutts/status/172448195723530240" target="blank">Matts Cutts</a>
            </div>
        </div>
        <div id="content" class="box lifted jquery-shadow jquery-shadow-lifted">
            ...
            <form action="" method="POST"> 
                ...
                <div style="font-weight: normal"> 
                    <a style="text-decoration: none" href="" onclick="$('#img,form').height(335);$('#content').height(342);$(this).next().show();return false;"><?php echo t('Lost your password', false); ?></a> ?
