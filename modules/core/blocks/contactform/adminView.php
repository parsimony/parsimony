...
<div style="padding:9px 0">
    <label><?php echo t('Activate Recaptcha Protection', FALSE); ?></label>
    <input type="hidden" value="0" name="recaptcha_activation" />
	<input type="checkbox" name="recaptcha_activation" value="1" <?php
	if ($this->getConfig('recaptcha_activation') == 1)
	    echo 'checked="checked"';
	?> />
</div>
<div class="placeholder">
    <label><?php echo t('Public Key', FALSE); ?></label>
    <input type="text" name="recaptcha_publickey" value="<?php echo $this->getConfig('recaptcha_publickey'); ?>">
</div>
<div class="placeholder">
    <label><?php echo t('Private Key', FALSE); ?></label>
    <input type="text" name="recaptcha_privatekey" value="<?php echo $this->getConfig('recaptcha_privatekey'); ?>">
</div>
<a href="https://www.google.com/recaptcha/admin/create" target="_blank"><?php echo t('Generate Keys'); ?></a>
<div style="padding:9px 0">
