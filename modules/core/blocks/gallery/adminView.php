...
<style>
    ...
    .template:hover span.deleteimg{display: block;position: absolute;top: 0;right: 0;border: #666 solid 1px;background: url(/admin/img/icons_white.png) -96px -128px, #333;}
...
<div>
        ...
        <div class="floatleft gradStyle" id="settings">
            <div id="globalsettings"><span class="settings"><?php echo t('Global Settings', false); ?></span><br>
                ...
                <div class="labels" style="display: inline;">
                    <label style="width: 83px;" class="ellipsis"><?php echo t('Width', false); ?> (px): </label><input style="width: 40px;" type="text" name="width" value="" />
                </div>
                <div class="labels" style="display: inline;">
                    <label style="width: 83px;margin: 4px 0 4px 10px;" class="ellipsis"><?php echo t('Height', false); ?> (px): </label><input style="width: 40px;" type="text" name="height" value="" />
                </div>
            </div>
	...
	if (!empty($imgs)) {
		...
		<div class="template"> 
		    <span onclick="$(this).parent().remove()" class="deleteimg ui-icon ui-icon-closethick"></span>
		    <img title="" src="/<?php BASE_PATH ?>thumbnail?x=100&y=100&crop=1&path=<?php echo PROFILE_PATH ?>core/files/<?php echo $id ?>" alt="">
