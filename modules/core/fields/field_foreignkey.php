...
*/ 
        public function __construct($module, $entity, $name, $type='INT', $characters_max=11, $characters_min=0, $label='', $text_help='', $msg_error='invalid', $default='', $required=TRUE,$regex='[0-9]*', $visibility = 7, $link='', $templatelink='') {
