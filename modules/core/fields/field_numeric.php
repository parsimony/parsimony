...
class field_numeric extends \field {
	 ...
	 * @param string $regex by default '^[1-9\-]?[0-9]*$'
	 */
	public function __construct($module, $entity, $name, $type = 'INT', $characters_max = '2', $characters_min = 0, $label = '', $text_help = '', $msg_error = 'invalid', $default = '', $required = TRUE, $regex = '^[1-9\-]?[0-9]*$', $visibility = 7) {
