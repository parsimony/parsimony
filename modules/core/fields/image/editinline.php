...
<div class="parsieditinline" id="img_<?php echo $row->getId()->value; ?>" style="display: none" data-module="<?php echo $this->entity->getModule(); ?>" data-entity="<?php echo $this->entity->getName(); ?>" data-property="<?php echo $this->name; ?>" data-id="<?php echo $row->getId()->value; ?>">
...
<div id="upload_image_<?php echo $row->getId()->value; ?>" style="position: relative;">
	<div id="image_thumb_<?php echo $row->getId()->value; ?>" class="field-image-previewContainer">
		<img src="<?php echo BASE_PATH . $this->entity->getModule().'/'.$this->path.'/'.s($this->value); ?>?x=<?php echo $this->width; ?>&y=<?php echo $this->height; ?>" class="field-image-preview" />
	</div>
...
<script LANGUAGE="JavaScript" type="text/javascript"> 
	$(document).ready(function(){
		$("#upload_image_<?php echo $row->getId()->value; ?>").parsimonyUpload({ajaxFile: "<?php echo BASE_PATH. $this->entity->getModule(); ?>/callField",
			ajaxFileParams: {
