...
<div class="placeholder">
    ...
    ?>
    <input type="range" min="0" max="100" step="<?php echo $step; ?>" id="<?php echo $this->name ?>" name="<?php echo $this->name ?>" value="<?php echo $this->default ?>" <?php if(!empty($this->regex)) echo 'pattern="'.$this->regex.'"' ?> <?php if($this->required) echo 'required' ?> />
</div>
