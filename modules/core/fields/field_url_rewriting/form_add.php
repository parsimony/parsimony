...
<div class="placeholder">
    ...
    <input type="text" autocomplete="off" name="<?php echo $this->name ?>" class="<?php echo $this->name ?>" value="<?php echo $this->default ?>" <?php if (!empty($this->regex))
            echo 'pattern="' . $this->regex . '"' ?> <?php if ($this->required)
            echo 'required' ?> />
</div>