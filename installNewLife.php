...
$lang['fr']['directory (and sub-directories) using an FTP client'] = '(et ses sous-dossiers) via un client FTP';
...
while (1) {
    switch ($step) {
        ...
        case 2:
            ...
            if (!is_readable('modules/') || !is_readable('modules/core/') || !is_readable('modules/core/model/') || !is_writable('modules/') || !is_writable('modules/core/') || !is_writable('modules/core/model/') || !is_writable('modules/core/model/user.php') ){
