...
(function( $ ){
	...
	init : function( options ) {
		...
		initContext.append('<div class="parsimonyDND" style="relative"><div class="parsimonyResizeInfo parsimonyResize"><span></span> | <a href="#" class="parsimonyResizeReInit" style="color:#fff">Reinit</a> | <a href="#" class="parsimonyResizeClose" style="color:#fff">x</a></div><div class="parsimonyResize se"></div><div class="parsimonyResize nw"></div><div class="parsimonyResize ne"></div><div class="parsimonyResize sw"></div></div>');
		...
		dnd.on("mousedown.parsimonyDND",function(e){
			...
			$(".parsimonyResizeInfo span",initContext).text("W : " + $this.width() + "px | H : " + $this.height() + "px | T : " + $this.css("top") + " | L : " + $this.css("left") );
		...
		initContext.find(".parsimonyResizeReInit").on("click.parsimonyDND",function(e){
		    ...
		    e.preventDefault();
		    $(this).closest(".parsimonyDND").parsimonyDND("reInit").parsimonyDND("destroy");
		});
