...
(function( $ ){
	...
	init : function( options ) {
		...
		$this.append('<div class="parsimonyResizeInfo parsimonyResize"><span></span> | <a href="#" class="parsimonyResizeReInit" style="color:#fff">Reinit</a> | <a href="#" class="parsimonyResizeClose" style="color:#fff">x</a></div><div class="parsimonyResize se"></div><div class="parsimonyResize nw"></div><div class="parsimonyResize ne"></div><div class="parsimonyResize sw"></div>');
		...
		$this.find(".parsimonyResizeReInit").on("click.parsimonyDND",function(e){
		    ...
		    $(this).closest(".parsimonyDND").parsimonyDND("reInit");
                ...
                $this.find(".parsimonyResizeClose").on("click.parsimonyDND",function(e){
		    e.preventDefault();
