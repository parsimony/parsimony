...
while (1) {
    switch ($step) {
	    ...
	    echo '<div style="display:none">';
            ...
            $core->getEntity('post')->insertInto(array('id_post' => '1', 'title' => 'My first Post','url' => 'my-first-post','content' => 'Hello, it`s my first post, you can edit me in edit mode.','excerpt' => '','publicationGMT' => gmdate('Y-m-d H:i:s', time()),'author' => '1','has_comment' => '1','ping_status' => '1'));
	    echo '</div>';
            $configObj = new \core\classes\config('config.php', TRUE);
